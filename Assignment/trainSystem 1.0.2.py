    ...
    #If can, this happen
        ...
        if ( station > 0 and station < 18 ):
            if ( ticket_available[station-1] > 0 ):
               ...
               list1()
               begin()
        #If user type in 20, it will go to page 2.
        elif ( station == 20 ):
            os.system('cls')
            list2()
            begin()
        #If user type 19, it will go back to page 1.
        elif( station == 19 ):
            os.system('cls')
            list1()
            begin()
        #If usertype in 99, the system will shut down.
        elif ( station == 99 ):
            raw_input("\nThanks for using our system. Have fun.")
        #If user type the rest of number other than above.
        else :
...
def balanceTrue(total_price,timeNow,stationName,amount,counter):
    ...
    if ticketPrintOut == "40" :
        ...
        raw_input("\nPlease check your current directory to take your ticket.\nName : ticket" + str(counter) + ".txt\nPress Enter to continue.")
        os.system('cls')
        list1()
        begin()
    else:
...
def amount_want_to_buy(station):
    ...
    #If can't, this happen
        ...
        raw_input("\nPlease give a valid integer value. Try again.")
